...
[![](https://img.shields.io/badge/github-devilbox%2Fdocker--php--fpm--5.3-red.svg)](https://github.com/devilbox/docker-php-fpm-5.3 "github.com/devilbox/docker-php-fpm-5.3")
...
[![](https://img.shields.io/docker/pulls/devilbox/php-fpm-5.3.svg)](https://hub.docker.com/r/devilbox/php-fpm-5.3)
...
> ##### 🐱 GitHub: [devilbox/docker-php-fpm-5.3](https://github.com/devilbox/docker-php-fpm-5.3)
...
| [`jessie`][tag_jessie]          | master       |  `amd64`, `i386`, `arm64`, `arm/v7`, `arm/v6` |
| [`stretch`][tag_stretch]        | master       |  `amd64`, `i386`, `arm64`, `arm/v7`, `arm/v6` |

[tag_latest]: https://github.com/devilbox/docker-php-fpm-5.3/blob/master/Dockerfiles/Dockerfile.latest
[tag_jessie]: https://github.com/devilbox/docker-php-fpm-5.3/blob/master/Dockerfiles/Dockerfile.jessie
[tag_stretch]: https://github.com/devilbox/docker-php-fpm-5.3/blob/master/Dockerfiles/Dockerfile.stretch
...
| [`jessie-<tag>`][tag_jessie]    | git: `<tag>` |  `amd64`, `i386`, `arm64`, `arm/v7`, `arm/v6` |
| [`stretch-<tag>`][tag_stretch]  | git: `<tag>` |  `amd64`, `i386`, `arm64`, `arm/v7`, `arm/v6` |
...
[lnk_ereg]: https://github.com/devilbox/docker-php-fpm/tree/master/php_modules/ereg
